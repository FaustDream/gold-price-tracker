...
### v1.2.0 (2026-02-28)
*   **重磅功能**：任务栏嵌入模式。程序窗口会自动吸附在系统托盘（时间区域）左侧，完美融入 Windows 任务栏。
*   **界面重构**：全新水平布局 (`HBox`)，去除边框，高度适配任务栏，背景默认深色透明。
*   **趋势指示**：新增涨跌箭头 (▲/▼)，红色代表上涨，绿色代表下跌，行情走势一目了然。
*   **交互优化**：支持自动重新定位，防止分辨率改变或任务栏移动后位置错乱。
